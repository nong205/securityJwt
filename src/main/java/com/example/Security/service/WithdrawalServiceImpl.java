...
import com.example.Security.domain.WithdrawalStatus;
import com.example.Security.modal.User;
import com.example.Security.modal.Withdrawal;
import com.example.Security.repository.WithdrawalRepository;
import lombok.With;
...
public class WithdrawalServiceImpl implements WithdrawalService{
    ...
    @Override
    public List<Withdrawal> getAllWithdrawalRequest() throws Exception {
